...
function probeOracle() {
    ...
    const proc = spawnSync('python3', [
        '-c',
        'import sys; import os; sys.path.insert(0, os.environ.get("BLENDERGRANNY_PATH") or os.path.expanduser("~/.cache/granny-ro-js/blendergranny")); from io_scene_gr2.gr2.animation import extract_animation_set, _evaluate_curve',
    ], { encoding: 'utf8' });
    if (proc.status !== 0) {
