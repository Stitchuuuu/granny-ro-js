/*
 * gr2_decompress — i386 Win32 shim that loads granny2.dll and re-bakes
 * a Granny .gr2 file with all sections decompressed (Oodle0 / NoCompression).
 *
 * Vendored verbatim from :
 *   https://github.com/magcius/noclip.website
 *   src/RagnarokOnline/tools/gr2_decompress.c @ main (fetched 2026-06-28)
 *
 * SPDX-License-Identifier: MIT
 * Copyright (c) noclip.website contributors
 *
 * Reused under the noclip.website MIT license — see
 * https://github.com/magcius/noclip.website/blob/main/LICENSE
 *
 * Purpose in granny-ro-js : byte-exact ground-truth oracle for the JS
 * Oodle0 port, used in the live-oracle test path (`npm run test:live`).
 * Compile with mingw-w64 :
 *   i686-w64-mingw32-gcc -static -O2 -o gr2_decompress.exe gr2_decompress.c
 * Run via Wine (under qemu-i386-static on arm64) with granny2.dll in CWD :
 *   wine ./gr2_decompress.exe input.gr2 output.gr2
 */
#include <windows.h>
#include <stdio.h>
#include <stdlib.h>
